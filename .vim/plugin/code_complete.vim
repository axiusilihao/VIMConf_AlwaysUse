...
let g:template['c']['for'] = "for( ; ; )\{\<cr>".
            \g:rs."...".g:re."\<cr>}\<cr>"
let g:template['c']['main'] = "int main(int argc, char \*argv\[\])\<cr>{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['switch'] = "switch ()\{\<cr>case ".g:rs."...".g:re." :\<cr>break;\<cr>case ".
            \g:rs."...".g:re." :\<cr>break;\<cr>default :\<cr>break;\<cr>}"
let g:template['c']['if'] = "if()\{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['while'] = "while()\{\<cr>\<cr>}"
let g:template['c']['ife'] = "if()\{\<cr>".g:rs."...".g:re."\<cr>} else\{\<cr>".g:rs."...".g:re."\<cr>}"
let g:template['c']['fd'] = "#ifdef \<cr>\<cr>#endif"
let g:template['c']['fn'] = "#ifndef \<cr>\<cr>#endif"
let g:template['c']['fne'] = "#ifndef \<cr>\<cr>#else\<cr>\<cr>#endif"
let g:template['c']['fde'] = "#ifdef \<cr>\<cr>#else\<cr>\<cr>#endif"
